...
public class ListaAgendamento extends javax.swing.JFrame {
     ...
     */
    public ListaAgendamento() throws SQLException {
        initComponents();
        preencherTabela();
    }
     ...
     private void preencherTabela() throws SQLException  {
       ...
       List<agendamento> agendamentos = pr.ProcurarAgendamento();

       for (agendamento ag : agendamentos) {
            modelo.addRow(new Object[]{ag.getID(),ag.getIDCliente(), ag.getIDFuncionario(), ag.getCorte(), ag.getData(), ag.getHora()});
        }
    }
    ...
    private void initComponents() {
        ...
        tabelaAgendamento.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "cliente", " barbeiro", "Corte", "data", "Hora"
            }
        ));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(ListaAgendamento.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
