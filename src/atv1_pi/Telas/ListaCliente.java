...
public class ListaCliente extends javax.swing.JFrame {
     ...
     */
    public ListaCliente() throws SQLException {
        initComponents();
         preencherTabela();
    }
    ...
    private void preencherTabela() throws SQLException {
       ...
       List<cliente> clientes = pr.ProcurarTdCliente();

       for (cliente cliente : clientes) {
            modelo.addRow(new Object[]{cliente.getID(), cliente.getNome(), cliente.getEmail(), cliente.getCpf(),cliente.getTelefone(),cliente.getSenha()});
        }
    }
